...
export function renderCustomIcon(icon: SimpleIcon, theme: string): React.ReactElement {
...
export function IconCloud({ iconSlugs }: DynamicCloudProps): React.ReactElement {
